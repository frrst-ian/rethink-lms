        ...
        <div className={styles.gaugeWrapper}>
            <ResponsiveContainer width="100%" height={160}>
                <RadialBarChart
                    ...
                    endAngle={0}
                    data={[
                        { value: 100, fill: "#2a2840" },
                        { value, fill: value > 60 ? "#ef517a" : "#5067e9" },
                    ]}
                    barSize={14}
                >
            ...
            <div className={styles.gaugeCenter}>
                <p
                    ...
                    style={{ color: value > 60 ? "#ef517a" : "#5067e9" }}
                >
        ...
        <div className={styles.dashWrapper}>
            <div className={styles.pageHeader}>
                ...
                <p className={styles.pageSub}>
                    Overview of your courses and student activity
                </p>
            </div>
            ...
            <div className={styles.chartsRow}>
                ...
                <div className={styles.chartCard}>
                    ...
                    <div className={styles.legend}>
                        ...
                        />
                        <span className={styles.legendText}>
                            Clean ({data.totalSubmissions - data.flaggedCount})
                        </span>
                    </div>
                </div>
            </div>
                            ...
                            <div key={s.id} className={styles.submissionRow}>
                                <div className={styles.subInfo}>
                                    ...
                                    <div>
                                        ...
                                        <p className={styles.subAssignment}>
                                            {s.assignment.title}
                                        </p>
                                    </div>
                                </div>
...
function StudentDashboard({ data }) {
    ...
    const isHigh = aiPct != null && aiPct > 60;
    ...
    return (
        <div className={styles.dashWrapper}>
            ...
            <div className={styles.chartsRow}>
                <div
                    className={`${styles.chartCard} ${isHigh ? styles.chartCardWarning : ""}`}
                >
                    ...
                    {isHigh && (
                        <div className={styles.warningBadge}>
                            <AlertTriangle size={13} strokeWidth={1.75} />
                            Your submissions are scoring high on AI detection.
                            Try writing more in your own words.
                        </div>
                    )}
                </div>
            </div>
                ...
                {data.upcomingAssignments.length === 0 ? (
                    ...
                    <div className={styles.submissionList}>
                        {data.upcomingAssignments.map((a) => (
                            <NavLink
                                key={a.id}
                                to={`/courses/${a.course.id}/assignments/${a.id}`}
